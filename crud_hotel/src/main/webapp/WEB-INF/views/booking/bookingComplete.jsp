<%@ page import="com.sh.crud.booking.model.entity.Booking" %><%--
    ...
    <div class="flex h-screen items-center justify-center">
        <div class="w-80 rounded bg-gray-50 px-6 pt-8 shadow-lg">
            <div class="flex flex-col justify-center items-center gap-2">
                <h3 class="p-4 mb-4 text-sm text-black rounded-lg bg-orange-100 dark:bg-gray-800 dark:text-yellow-300">
                    CRUD Hotel Booking Complete</h3>
            </div>
            <div class="flex flex-col justify-center items-center gap-2">
            ...
            <div class="flex flex-col gap-3 border-b py-6 text-xs">
                ...
                <p class="flex justify-between">
                    ...
                    <span>
                            <fmt:parseDate value="${booking.checkInDate}" pattern="yyyy-mm-dd'T'HH:mm"
                                           var="checkInDate"/>
                ...
                <div class="py-4 justify-center items-center flex flex-col gap-2">
                    <p class="flex gap-2">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none">
                            <path d="M21.3 12.23h-3.48c-.98 0-1.85.54-2.29 1.42l-.84 1.66c-.2.4-.6.65-1.04.65h-3.28c-.31 0-.75-.07-1.04-.65l-.84-1.65a2.567 2.567 0 0 0-2.29-1.42H2.7c-.39 0-.7.31-.7.7v3.26C2 19.83 4.18 22 7.82 22h8.38c3.43 0 5.54-1.88 5.8-5.22v-3.85c0-.38-.31-.7-.7-.7ZM12.75 2c0-.41-.34-.75-.75-.75s-.75.34-.75.75v2h1.5V2Z"
                                  fill="#000"></path>
                        ...
                        info@http://localhost:8080/crud_hotel/
                    </p>
                    <p class="flex gap-2">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none">
                            <path fill="#000"
