...
<div class="flex h-screen">
    ...
    <div class="flex-1 flex flex-col">
        ...
        <div class="flex justify-between items-center p-10">
            <div><p class="text-2xl font-bold text-orange-100 dark:text-orange-300">프리미어</p></div>
            <div>
                ...
                <div id="dropdown" class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700">
                    <ul class="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownDefaultButton">
                        <li>
                            <a href="#" class="block px-4 py-2 hover:bg-orange-100 dark:hover:bg-orange-200 dark:hover:text-black">T401
                        ...
                        <li>
                            <a href="#" class="block px-4 py-2 hover:bg-orange-100 dark:hover:bg-orange-200 dark:hover:text-black">T402
                                <span class="inline-flex items-center bg-green-100 text-green-800 text-xs font-medium px-2.5 py-0.5 rounded-full dark:bg-green-900 dark:text-green-300">
                                    <span class="w-2 h-2 me-1 bg-green-500 rounded-full"></span>
                                    예약가능
                                </span>
                        ...
                        <li>
                            <a href="#" class="block px-4 py-2 hover:bg-orange-100 dark:hover:bg-orange-200 dark:hover:text-black">Q403
                                <span class="inline-flex items-center bg-green-100 text-green-800 text-xs font-medium px-2.5 py-0.5 rounded-full dark:bg-green-900 dark:text-green-300">
                                    <span class="w-2 h-2 me-1 bg-green-500 rounded-full"></span>
                                    예약가능
                                </span>
                        ...
                        <li>
                            <a href="#" class="block px-4 py-2 hover:bg-orange-100 dark:hover:bg-orange-200 dark:hover:text-black">Q404
                                <span class="inline-flex items-center bg-green-100 text-green-800 text-xs font-medium px-2.5 py-0.5 rounded-full dark:bg-green-900 dark:text-green-300">
                                    <span class="w-2 h-2 me-1 bg-green-500 rounded-full"></span>
                                    예약가능
                                </span>
                        ...
                        <li>
                            <a href="#" class="block px-4 py-2 hover:bg-orange-100 dark:hover:bg-orange-200 dark:hover:text-black">Q405
                        ...
                        <li>
                            <a href="#" class="block px-4 py-2 hover:bg-orange-100 dark:hover:bg-orange-200 dark:hover:text-black">Q406
                                <span class="inline-flex items-center bg-red-100 text-red-800 text-xs font-medium px-2.5 py-0.5 rounded-full dark:bg-red-900 dark:text-red-300">
                                    <span class="w-2 h-2 me-1 bg-red-500 rounded-full"></span>
                                    예약불가
                                </span>
                        ...
                        <li>
                            <a href="#" class="block px-4 py-2 hover:bg-orange-100 dark:hover:bg-orange-200 dark:hover:text-black">T501
                                <span class="inline-flex items-center bg-green-100 text-green-800 text-xs font-medium px-2.5 py-0.5 rounded-full dark:bg-green-900 dark:text-green-300">
                                    <span class="w-2 h-2 me-1 bg-green-500 rounded-full"></span>
                                    예약가능
                                </span>
                        ...
                        <li>
                            <a href="#" class="block px-4 py-2 hover:bg-orange-100 dark:hover:bg-orange-200 dark:hover:text-black">T502
                                <span class="inline-flex items-center bg-green-100 text-green-800 text-xs font-medium px-2.5 py-0.5 rounded-full dark:bg-green-900 dark:text-green-300">
                                    <span class="w-2 h-2 me-1 bg-green-500 rounded-full"></span>
                                    예약가능
                                </span>
                        ...
                        <li>
                            <a href="#" class="block px-4 py-2 hover:bg-orange-100 dark:hover:bg-orange-200 dark:hover:text-black">Q503
                                <span class="inline-flex items-center bg-red-100 text-red-800 text-xs font-medium px-2.5 py-0.5 rounded-full dark:bg-red-900 dark:text-red-300">
                                    <span class="w-2 h-2 me-1 bg-red-500 rounded-full"></span>
                                    예약불가
                                </span>
                        ...
                        <li>
                            <a href="#" class="block px-4 py-2 hover:bg-orange-100 dark:hover:bg-orange-200 dark:hover:text-black">Q504
                                <span class="inline-flex items-center bg-red-100 text-red-800 text-xs font-medium px-2.5 py-0.5 rounded-full dark:bg-red-900 dark:text-red-300">
                                    <span class="w-2 h-2 me-1 bg-red-500 rounded-full"></span>
                                    예약불가
                                </span>
                        ...
                        <li>
                            <a href="#" class="block px-4 py-2 hover:bg-orange-100 dark:hover:bg-orange-200 dark:hover:text-black">Q505
                                <span class="inline-flex items-center bg-green-100 text-green-800 text-xs font-medium px-2.5 py-0.5 rounded-full dark:bg-green-900 dark:text-green-300">
                                    <span class="w-2 h-2 me-1 bg-green-500 rounded-full"></span>
                                    예약가능
                                </span>
                        ...
                        <li>
                            <a href="#" class="block px-4 py-2 hover:bg-orange-100 dark:hover:bg-orange-200 dark:hover:text-black">Q506
                                <span class="inline-flex items-center bg-green-100 text-green-800 text-xs font-medium px-2.5 py-0.5 rounded-full dark:bg-green-900 dark:text-green-300">
                                    <span class="w-2 h-2 me-1 bg-green-500 rounded-full"></span>
                                    예약가능
                                </span>
