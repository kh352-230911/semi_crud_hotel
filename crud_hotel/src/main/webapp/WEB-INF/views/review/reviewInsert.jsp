...
<div class="container bg-orange-100 mx-auto mt-8 mb-16">
    <form name="reviewInsertFrm" method="post" enctype="multipart/form-data">
        <div class="w-9/12 flex-wrap mx-auto">
            <div class="w-1/4 mt-8 border border-gray-200 bg-gray-50">
                    <label for="revId"></label>
                    <input type="text" id="revId" name="title" class="w-full text-sm text-gray-800 bg-gray-200 border-0 focus:ring-blue-500" value="작성자 : ${loginMember.memberId}" required readonly>
            </div>
